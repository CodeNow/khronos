...
module.exports = function buildCanary (job) {
  ...
  log.info('Canary Testing Github Branch Flow')

  return Promise.fromCallback(function (cb) {
    github.gitdata.createReference({
      user: process.env.CANARY_GITHUB_USER,
      repo: process.env.CANARY_GITHUB_REPO,
      ref: 'refs/heads/'+process.env.CANARY_BRANCH_NAME,
      sha: process.env.CANARY_BRANCH_SHA
    }, cb)
  })
    .delay(process.env.CANARY_BRANCH_START_DELAY)
    .then(function () {
