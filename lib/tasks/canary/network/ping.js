...
class NetworkOrgCanary extends CanaryBase {
  ...
  test () {
    ...
    .then(() => {
      ...
      console.log('Pulling image!!!!!!!!, yo')
      return this.docker.pull(process.env.NETWORK_PING_IMAGE)
    })
    .then(() => {
