...
/**
 * Enqueue an `asg.check-created` job when an organization is created
 *
 ...
 */
module.exports = function OrganizationCreated (job) {
  var log = logger.child({
    tx: true,
    data: job,
    method: 'OrganizationCreated'
  })
  log.info('OrganizationCreated called')
