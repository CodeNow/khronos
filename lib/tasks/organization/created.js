...
module.exports = function (job) {
  var log = logger.child({
    tx: true,
    data: job,
    method: 'Organization.Created'
  })
  log.info('Organization.Created called')
  ...
  return Promise
    ...
    .then((docks) => {
      ...
      if (!dockExists) {
        ...
        throw new TaskFatalError('Organization.Created', 'No Docks exist!')
      }
    })
    .catch((err) => {
      log.error({ err: err }, 'Error in Organization.Created')
      throw err
    })
}
